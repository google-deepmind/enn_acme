...
python3 -m venv enn_acme_testing
source enn_acme_testing/bin/activate
...
pytype -j "${N_CPU}" enn_acme

# Run all tests.
pytest -n "${N_CPU}" enn_acme

# Clean-up.
deactivate
rm -rf enn_acme_testing/
